...
func (e eqCreateUserParamasMatcher) Matches(x interface{}) bool {
...
func (e eqCreateUserParamasMatcher) String() string {
	return fmt.Sprintf("matches arg %v and password %v", e.arg, e.password)
}

func EqCreateUserParams(arg db.CreateUserParams, password string) gomock.Matcher {
	return eqCreateUserParamasMatcher{arg, password}
}
